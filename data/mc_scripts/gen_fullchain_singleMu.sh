...
cd /global/homes/c/cjslin/DUNE/protodune/mc_data/singleMu
...
DATAOUT=/project/projectdirs/dune/users/cjslin/protodune/mc_data/singleMu/${JOBID}
DATAOUT2=/project/projectdirs/dune/users/cjslin/protodune/mc_data/singleMu/
LOGOUT=/project/projectdirs/dune/users/cjslin/protodune/mc_data/logs/singleMu_${JOBID}.log

GENJOB=/project/projectdirs/dune/users/cjslin/protodune/mc_scripts/single_muon.fcl
...
G4FILE=g4_singleMu_${JOBID}.root
DETSIMFILE=detsim_${JOBID}.root
RECOFILE=reco_singleMu_${JOBID}.root
